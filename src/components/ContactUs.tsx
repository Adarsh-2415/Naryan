    ...
    <section id="contact" className="pt-16 pb-0 md:pt-24 md:pb-0 bg-white relative overflow-hidden border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <ScrollReveal direction="up" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-light text-brand-dark font-semibold text-xs tracking-wide shadow-sm uppercase border border-brand-soft/20">
          ...
          <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-brand-dark leading-tight">
            We are here to support your recovery pathway
          </h2>
          <p className="text-text-body/80 text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
            Contact our customer support team or visit us directly at Civil Lines to coordinate your consultation slots.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          ...
          <ScrollReveal direction="up" delay={0}>
            <div className="group bg-slate-50/50 hover:bg-white rounded-2xl border border-slate-100 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center flex flex-col items-center justify-center min-h-[180px]">
              ...
              <a href={`tel:${settings.phone.replace(/[^+\d]/g, "")}`} className="font-heading font-bold text-sm md:text-base text-brand-secondary hover:underline">
                {settings.phone}
              </a>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal direction="up" delay={300}>
            <div className="group bg-slate-50/50 hover:bg-white rounded-2xl border border-slate-100 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center flex flex-col items-center justify-center min-h-[180px]">
              ...
              <a href={`mailto:${settings.email}`} className="font-heading font-bold text-sm md:text-base text-brand-secondary hover:underline">
                {settings.email}
              </a>
            </div>
          </ScrollReveal>
            ...
            <div className="bg-white rounded-3xl border border-slate-100/90 shadow-2xl p-6 md:p-8 relative">
              ...
              {!isSubmitted ? (
                <form onSubmit={handleFormSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 rounded-xl bg-slate-50 border text-sm text-brand-dark placeholder-slate-400 focus:outline-none transition-all duration-200 ${formErrors.name ? "border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-slate-200 focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/15"
                          }`}
                      />
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 rounded-xl bg-slate-50 border text-sm text-brand-dark placeholder-slate-400 focus:outline-none transition-all duration-200 ${formErrors.phone ? "border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-slate-200 focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/15"
                          }`}
                      />
                  ...
                  {/* Address TextArea */}
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-brand-dark/75 block">Message</label>
                    <textarea
                      name="address"
                      rows={3}
                      placeholder="Please describe your detailed Message here..."
                      className={`w-full px-4 py-2.5 rounded-xl bg-slate-50 border text-sm text-brand-dark placeholder-slate-400 focus:outline-none transition-all duration-200 resize-none ${formErrors.address ? "border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-slate-200 focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/15"
                        }`}
                    />
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 rounded-xl bg-slate-50 border text-sm text-brand-dark placeholder-slate-400 focus:outline-none h-11 transition-all duration-200 ${formErrors.captcha ? "border-red-500 focus:ring-2 focus:ring-red-500/20" : "border-slate-200 focus:border-brand-secondary focus:ring-2 focus:ring-brand-secondary/15"
                          }`}
                      />

...
import { Heart, Baby, Sparkles, Brain, Droplet, Eye, Ear, Activity, Check, ArrowRight, Calendar } from "lucide-react";

// Fallback legacy array
const fallbackTreatmentsData = [
  {
    treatment_id: "cardiovascular",
    title: "Cardiovascular Health",
    tag: "Cardiology",
    icon_name: "Heart",
    icon_color_class: "text-red-500 bg-red-50",
    image_url: "/cardiovascular.png",
  ...
  {
    treatment_id: "infant-health",
    title: "Infant Health Issues",
    tag: "Pediatrics",
    icon_name: "Baby",
    icon_color_class: "text-amber-500 bg-amber-50",
    image_url: "/infant.png",
  ...
  {
    treatment_id: "leucorrhoea",
    title: "Leucorrhoea Treatment",
    tag: "Gynaecology",
    icon_name: "Sparkles",
    icon_color_class: "text-purple-500 bg-purple-50",
    image_url: "/leucorrhoea.png",
  ...
  {
    treatment_id: "child-disabilities",
    title: "Child Disabilities",
    tag: "Pediatrics / Neurology",
    icon_name: "Brain",
    icon_color_class: "text-indigo-500 bg-indigo-50",
    image_url: "/child-disabilities.jpg",
  ...
  {
    treatment_id: "renal-disorders",
    title: "Renal Disorders",
    tag: "Nephrology",
    icon_name: "Droplet",
    icon_color_class: "text-blue-500 bg-blue-50",
    image_url: "/renal-disorders.png",
  ...
  {
    treatment_id: "eyes-treatment",
    title: "Eyes Treatment",
    tag: "Ophthalmology",
    icon_name: "Eye",
    icon_color_class: "text-teal-500 bg-teal-50",
    image_url: "/eyes-treatment.png",
  ...
  {
    treatment_id: "ear-treatment",
    title: "Ear Treatment",
    tag: "Otology",
    icon_name: "Ear",
    icon_color_class: "text-orange-500 bg-orange-50",
    image_url: "/ear-treatment.png",
  ...
  {
    treatment_id: "gastrointestinal",
    title: "Gastrointestinal Diseases",
    tag: "Gastroenterology",
    icon_name: "Activity",
    icon_color_class: "text-emerald-500 bg-emerald-50",
    image_url: "/gastrointestinal.png",
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {loading ? (
                ...
                items.map((item, idx) => {
                  const IconComponent = (LucideIcons as any)[item.icon_name] || LucideIcons.Activity;
                  return (
                    <ScrollReveal
                      key={item.id || idx}
                      direction="up"
                        ...
                        <div className="p-6 md:p-8 flex-grow flex flex-col justify-between">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-3.5 mb-4">
                              <div className={`p-2.5 rounded-xl shrink-0 ${item.icon_color_class || item.iconColor} transition-transform duration-300 group-hover:scale-110`}>

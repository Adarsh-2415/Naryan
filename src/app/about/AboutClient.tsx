      ...
      <main className="flex-grow bg-slate-50/50">
        ...
        <section id="story" className="py-20 md:py-28 relative">
          <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-24">
            ...
            {/* Section 1: Late Pt. Manohar Lal Sharma Ji */}
            ...
            {/* Section 2: Late Dr. J.N. Sharma */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center pt-16 border-t border-slate-100">
              {/* Left Side: Content */}
              <div className="lg:col-span-6 space-y-6">
                <div className="space-y-2">
                  <span className="text-xs font-bold text-brand-secondary tracking-widest uppercase block">
                  ...
                  <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-brand-dark leading-tight">
                    The Legacy of Late Dr. J.N. Sharma
                  </h2>
                </div>
                    ...
                    <div className="space-y-3.5 text-xs text-text-body/90 font-medium">
                      ...
                      <div className="space-y-1.5 pt-1">
                        ...
                        <ul className="list-disc list-inside pl-1 space-y-1 text-[11px] text-slate-500 font-bold">
                          ...
                          <li>Asian Homoeopathic Medical League</li>
                        </ul>
                      </div>
                    </div>
                  </div>
